...
public class AppInfoRequestDto {
    ...
    @Pattern(regexp = "\\b\\w{8}-\\w{4}-\\w{4}-\\w{4}-\\w{12}\\b", message = "Canonical UUIDs are 32 lowercase hexadecimal digits, displayed in five groups separated by hyphens in the form 8-4-4-4-12. For example: 123e4567-e89b-12d3-a456-4266554400a0. ")
